...
- En tidslinje nederst på kartet, fra ett døgn tilbake til nå.
- Drar du i den, viser kartet punktene fra det tidspunktet.
- Slipper du den på «nå», går kartet tilbake til å oppdatere seg selv.
