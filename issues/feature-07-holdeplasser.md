...
- Laget skal ha id `holdeplasser`, navn «Holdeplasser» og et passende ikon.
- Ett punkt per holdeplass eller stasjon.
- Punktene skal vise navnet på holdeplassen og hva slags trafikk som går der.
