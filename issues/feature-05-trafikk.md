...
- Laget skal ha id `trafikk`, navn «Trafikk» og et passende ikon.
- Ett punkt per registreringspunkt.
- Punktene skal vise navnet på punktet og hvilken vei det ligger på.
