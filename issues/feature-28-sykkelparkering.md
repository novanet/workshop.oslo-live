...
- Laget skal ha id `sykkelparkering`, navn «Sykkelparkering» og et passende ikon.
- Ett punkt per parkering.
- Punktene skal vise antall plasser og om det er under tak, når kilden vet det.
