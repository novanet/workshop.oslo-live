...
- Laget skal ha id `smilefjes`, navn «Smilefjes» og et passende ikon.
- Ett punkt per spisested i Oslo med en registrert karakter.
- Punktene skal vise navn, karakter og dato for tilsynet.
- Ikonet skal følge karakteren: blid, streng eller sur munn.
