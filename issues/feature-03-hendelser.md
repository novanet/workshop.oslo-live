...
- Laget skal ha id `hendelser`, navn «Hendelser» og et passende ikon.
- Ett punkt per hendelse med koordinat.
- Punktene skal vise overskrift, et sammendrag og når hendelsen ble meldt.
